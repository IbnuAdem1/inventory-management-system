              ...
              {filtered.map((item) => {
                ...
                return (
                  <tr key={item.id} className="border-b border-border/50 last:border-0 hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-5 py-3 text-right font-mono text-muted-foreground">${item.costPrice.toFixed(2)}</td>
                    <td className="px-5 py-3 text-right font-mono font-medium text-card-foreground">${item.sellingPrice.toFixed(2)}</td>
